package sv.com.moviesapp.utilities
...
class CustomTabLayout : TabLayout {
    ...
    private fun init() {
        mTypeface = Typeface.createFromAsset(context.assets, "fonts/GothamRoundedBold_21016.ttf")
    }
    ...
    override fun addTab(tab: Tab) {
        ...
        for (i in 0 until tabChildCount) {
            ...
            if (tabViewChild is TextView) {
                tabViewChild.setTypeface(mTypeface, Typeface.BOLD)
            }
        }
    }
}